...
@section('content')
    ...
    <div class="relative py-10 bg-blue-700">
        <div class="container mx-auto px-4 text-white">
            <h1 class="text-3xl font-bold mb-2">Add New Car</h1>
            <p class="text-lg">Add a new vehicle to your rental fleet</p>
        </div>
    </div>
            ...
            <form action="{{ route('admin.cars.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input type="number" min="1" max="15" name="seats" id="seats" value="{{ old('seats', 5) }}" required
                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                    </div>
                    ...
                    <div>
                        ...
                        <select name="car_type" id="car_type" required
                            ...
                            <option value="sport" {{ old('car_type') == 'sport' ? 'selected' : '' }}>Sport</option>
                        </select>
                    </div>
                    ...
                    <div>
                        <div class="flex items-center mt-6">
                            <input type="checkbox" name="air_conditioned" id="air_conditioned" value="1" {{ old('air_conditioned', '1') ? 'checked' : '' }}
                ...
                <div class="flex justify-between">
                    <a href="{{ route('admin.cars.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded">
                        Cancel
                    </a>
